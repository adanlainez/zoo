...
;( function( window ) {
	...
	AnimOnScroll.prototype = {
		...
		_init : function() { 
			//this.items = Array.prototype.slice.call( document.querySelectorAll( '#' + this.el.id + ' > .grid__item' ) );
			this.items = [].slice.call(this.el.querySelectorAll('.grid__item'));
...
;(function(window) {
	...
	GridFx.prototype._openItem = function(ev, item) {
		...
		this._setOriginal(item.getAttribute('data-href'));
